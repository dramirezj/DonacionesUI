  ...
  Plugin.prototype = {
    init: function(){
      var _this    = this,
          ...
          tooltip = jQuery("<div/>", {class: "tooltip", text: "Mininmo " + this.options.minChars + " caracteres"});
    ...
    addStatus: function(percentage){
      var status = "",
          text = "Minimo " + this.options.minChars + " caracteres",
    ...
    togglePassword: function(){
      var buttonShow = jQuery("<span/>", {class: "showPassword", html: ""}),
